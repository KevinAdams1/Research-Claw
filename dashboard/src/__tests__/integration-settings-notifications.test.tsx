 ...
 * Issue 7: Version v0.5.6 + glow header + GitHub link
...
// ============================================================
// Issue 7: Version v0.5.6 + GitHub link
// ============================================================

describe('Issue 7: Version v0.5.6 and GitHub link', () => {
  beforeEach(() => {
    useGatewayStore.setState({
  ...
  it('renders "Research-Claw v0.5.6" text in the about section', () => {
    render(<SettingsPanel />);

    // The glowing header should contain the version string
    expect(screen.getByText('Research-Claw v0.5.6')).toBeInTheDocument();
  });
  ...
  it('contains v0.5.6 in the glow header (info row removed to avoid duplication)', () => {
    render(<SettingsPanel />);
  ...
  it('diagnostics copy text contains v0.5.6', () => {
    // Verify by reading the source — the diagnostics array includes 'Research-Claw v0.5.6'
    // This is a structural test: the AboutSection handleCopyDiagnostics builds the string
    // with a hardcoded 'Research-Claw v0.5.6' on line 71 of SettingsPanel.tsx.
    // We verify the rendered component has the version header which uses the same string.
    render(<SettingsPanel />);

    const versionHeader = screen.getByText('Research-Claw v0.5.6');
